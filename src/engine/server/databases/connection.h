...
public:
	...
	virtual bool AddSeasonPoints(const char *pPlayer, int Points, char *pError, int ErrorSize) = 0;
	virtual bool ChangePowerStatus(const char *pPlayer, const char *PowerName, int Status, char *pError, int ErrorSize) = 0;
